...
Since I've already removed a fair amount of noise by setting `n.consensus = 4`, I'm just going to concatenate and merge the consensus peaks from each mark.
...
# R
# Basic sample sheet.
samples <- read.table("./ChIP_Seq/DiffBind/MergedPeaks/H3AC/SampleSheet_H3AC_DiffBind.csv", header=TRUE, sep = ",")
head(samples, 10)
```
...
Once more with `scale.full = TRUE`.

```{r DiffBind_merged_scale}
# R
h3ac <- RunDiffBind(outpath = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3AC/AllComparisons",
                   samplesheet = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3AC/SampleSheet_H3AC_DiffBind.csv", 
                   txdb = txdb,
                   n.consensus = 1,
                   se = "./ChIP_Seq/DiffBind/H3K27AC_SE/AllComparisons/NoBlock/ResultsTables/CLL-v-DL.AllPeaks.txt",
                   level = "Tissue", 
                   ...
                   heatmap.preset = "OrPu",
                   scale.full = TRUE)
faire <- RunDiffBind(outpath = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/FAIRE/AllComparisons",
                   samplesheet = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/FAIRE/SampleSheet_FAIRE_DiffBind.csv", 
                   txdb = txdb,
                   n.consensus = 1,
                   se = "./ChIP_Seq/DiffBind/H3K27AC_SE/AllComparisons/NoBlock/ResultsTables/CLL-v-DL.AllPeaks.txt",
                   level = "Tissue", 
                   ...
                   heatmap.preset = "PuGr",
                   scale.full = TRUE)
h3k4me1 <- RunDiffBind(outpath = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3K4ME1/AllComparisons",
                   samplesheet = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3K4ME1/SampleSheet_H3K4ME1_DiffBind.csv", 
                   txdb = txdb,
                   n.consensus = 1,
                   se = "./ChIP_Seq/DiffBind/H3K27AC_SE/AllComparisons/NoBlock/ResultsTables/CLL-v-DL.AllPeaks.txt",
                   level = "Tissue", 
                   ...
                   heatmap.preset = "BuOr",
                   scale.full = TRUE)
h3k27ac <- RunDiffBind(outpath = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3K27AC/AllComparisons",
                   samplesheet = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3K27AC/SampleSheet_H3K27AC_DiffBind.csv", 
                   txdb = txdb,
                   n.consensus = 1,
                   se = "./ChIP_Seq/DiffBind/H3K27AC_SE/AllComparisons/NoBlock/ResultsTables/CLL-v-DL.AllPeaks.txt",
                   level = "Tissue", 
...
I also want to run another comparison (CANCER v NORMAL), so I will set that up as well.

```{r DiffBind_cancernormal}
# R
...
And one more time, using the full scaling this time.

```{r DiffBind_cancernormal_scale}
# R
h3ac <- RunDiffBind(outpath = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3AC/CANCERvNORMAL",
                   samplesheet = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3AC/SampleSheet_H3AC_DiffBind.csv", 
                   txdb = txdb,
                   n.consensus = 1,
                   se = "./ChIP_Seq/DiffBind/H3K27AC_SE/AllComparisons/NoBlock/ResultsTables/CLL-v-DL.AllPeaks.txt",
                   ...
                   heatmap.preset = "OrPu",
                   scale.full = TRUE)
faire <- RunDiffBind(outpath = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/FAIRE/CANCERvNORMAL",
                   samplesheet = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/FAIRE/SampleSheet_FAIRE_DiffBind.csv", 
                   txdb = txdb,
                   n.consensus = 1,
                   se = "./ChIP_Seq/DiffBind/H3K27AC_SE/AllComparisons/NoBlock/ResultsTables/CLL-v-DL.AllPeaks.txt",
                   ...
                   heatmap.preset = "PuGr",
                   scale.full = TRUE)
h3k4me1 <- RunDiffBind(outpath = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3K4ME1/CANCERvNORMAL",
                   samplesheet = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3K4ME1/SampleSheet_H3K4ME1_DiffBind.csv", 
                   txdb = txdb,
                   n.consensus = 1,
                   se = "./ChIP_Seq/DiffBind/H3K27AC_SE/AllComparisons/NoBlock/ResultsTables/CLL-v-DL.AllPeaks.txt",
                   ...
                   heatmap.preset = "BuOr",
                   scale.full = TRUE)
h3k27ac <- RunDiffBind(outpath = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3K27AC/CANCERvNORMAL",
                   samplesheet = "./ChIP_Seq/DiffBind/MergedPeaks.scalefull/H3K27AC/SampleSheet_H3K27AC_DiffBind.csv", 
                   txdb = txdb,
                   n.consensus = 1,
                   se = "./ChIP_Seq/DiffBind/H3K27AC_SE/AllComparisons/NoBlock/ResultsTables/CLL-v-DL.AllPeaks.txt",
